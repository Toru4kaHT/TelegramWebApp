...
from sqlalchemy import update as sqlachemy_update, delete as sqlalchemy_delete
...
class BaseDAO:
    ...
    async def find_all(cls, **filter_by):
        """
        Асинхронно находит все экземляры по указоному фильтру.
...
# Продолжить с этого момента: "Создание индивидуальных классов для работы с таблицами"